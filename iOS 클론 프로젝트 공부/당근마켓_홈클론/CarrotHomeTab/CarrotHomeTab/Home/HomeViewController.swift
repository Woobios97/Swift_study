...
// [✅] 홈 뷰모델 만들기 (리스트 가져오고, 아이템 탭 했을 때의 행동 정의)
// [✅] 뷰모델은 리스트 가져오기 -> 네트워크롤 통해서 가져온다.
...
class HomeViewController: UIViewController {
    ...
    private func configuerCollectionView() {
        datasource = UICollectionViewDiffableDataSource<Section, Item>(collectionView: colletionView, cellProvider: { [self] collectionView, indexPath, item in
            guard let cell = colletionView.dequeueReusableCell(withReuseIdentifier: "ItemInfoCell", for: indexPath) as? ItemInfoCell else { return nil }
